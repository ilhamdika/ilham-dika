    ...
    <>
      {loading ? (
        ...
        <div className="pt-22 mobile:pt-10">
          <TypeIt className="dark:text-white justify-center text-center items-center flex text-4xl my-10 font-medium mobile:">Portfolio</TypeIt>
          ...
          <div className="grid grid-cols-3 laptop:flex-row dekstop:flex-row tablet:flex-row mobile:h-auto mobile:grid-cols-1 my-10">
            ...
            <CardPortfolio
              ...
              description={"a website for online medical consultations"}
            ...
            <CardPortfolio className={"bg-slate-900 bg-opacity-50 rounded-xl"} thumbnail={webTokokita} title={"Tokokita"} description={"e-commerce based grocery shopping from home"} href={"https://tokokita.co.id/"} />

            <CardPortfolio className={"bg-slate-900 bg-opacity-50 rounded-xl"} thumbnail={webPerpusKita} title={"Perpus Kita"} description={"e-commerce based library"} href={"https://web.perpuskita.id/"} />
